...
public class Main {
    ...
    private static void databaseInsertion(Connection connection, Student student) throws SQLException {
        String sql = "insert into students(registration_number,first_name,lastname,email,password) values ( ?,?,?,?,?)";
    ...
    private static Connection getPostgresSQLConnection() throws SQLException, ClassNotFoundException {
        ...
        // establish a connection
        return DriverManager.getConnection(Config.POSTGRES_DB_URL, Config.POSTGRES_DB_USER,
